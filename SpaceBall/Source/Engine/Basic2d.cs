...
namespace SpaceBall
{
    public class Basic2d
    {
        ...
        public Basic2d(string PATH, Vector2 POS, Vector2 DIMS)  //clase constructor para inicializar
        {
            pos = POS;
            dims = DIMS;
        ...
        public virtual void Draw(Vector2 OFFSET)  // Poner el objeto en la nave
        {
            if (myModel!=null)
            {
        ...
        public virtual void Draw(Vector2 OFFSET, Vector2 ORIGIN, Color COLOR)  // Poner el objeto en la nave
        {
            if (myModel != null)
            {
